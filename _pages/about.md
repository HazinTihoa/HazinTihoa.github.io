...
<div style="display: flex; align-items: flex-start;">
    ...
    <p style="margin-left: 20px;">
        <span style="font-size: 24px; font-weight: bold; ">Eﬀicient Trajectory Generation Based on Traversable Planes in 3D Complex Architec -tural Spaces (submitted to ICRA 2025)</span><br>
